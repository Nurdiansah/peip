...
<?php
	...
	if(isset($_GET['folder'])){
		...
		$queryDokumen = mysqli_query($conn, "SELECT folder.*, id_dokumen, kd_folder, nm_dokumen, thn_dokumen, upload.nama as yg_upload, waktu_diupload, rubah.nama as yg_rubah, waktu_dirubah, file
												FROM dokumen
