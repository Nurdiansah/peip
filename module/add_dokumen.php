<?php
    ...
    if(isset($_POST['add_dokumen'])){
        ...
        $expired_dokumen = $_POST['expired_dokumen'];
        ...
        if($cekDokumen > 0){
            ...
            $tambahData = mysqli_query($conn,"INSERT INTO dokumen (id_dokumen, nm_dokumen, kd_folder, thn_dokumen, diupload_oleh, waktu_diupload, dirubah_oleh, waktu_dirubah, expired, file) VALUES
                                                ('$newID', '$nama_dokumen', '$folder', '$tahun_dokumen', '$user', now(), '$user', now(), '$expired_dokumen', '$dokumen')");
            if ($tambahData){
