...
// nyari dokumen yg ecxpired, buat ditaro di box
$queryExpired = mysqli_query($conn, "SELECT kd_folder, menu, sub_menu, sub_folder, logo, count(id_dokumen) as jml_dok 
                                            FROM dokumen
                                            INNER JOIN ms_folder folder
                                                ON kd_folder = id_folder
                                            WHERE datediff(expired, now()) <= '30'
                                            GROUP BY kd_folder");
$totalExpired = mysqli_num_rows($queryExpired);
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <script>
                        am4core.ready(function() {
                            ...
                            chart.data = [{
                                ...
                                "subData": [{
                                    name: "Gas Nuri Arizona",
                                    value: <?= $dataSubOps['ops_gna']; ?>
                                }, {
                                    name: "Enc Rhayden",
                                    value: <?= $dataSubOps['ops_rdn']; ?>
                                }, {
                                    name: "Mitra Anugerah 32",
                                    value: <?= $dataSubOps['ops_ma32']; ?>
                                }, {
                                    name: "Mitra Anugerah 35",
                                    value: <?= $dataSubOps['ops_ma35']; ?>
                                }, {
                                    name: "Enc Kalijapat 2",
                                    value: <?= $dataSubOps['ops_kj2']; ?>
                                }, {
                                    name: "Enc Kalijapat 3",
                                    value: <?= $dataSubOps['ops_kj3']; ?>
                                }]
                            }, {
                                "data": "Crewing Dept",
                                ...
                                "subData": [{
                                    name: "Gas Nuri Arizona",
                                    value: <?= $dataSubCrw['crw_gna']; ?>
                                }, {
                                    name: "Enc Rhayden",
                                    value: <?= $dataSubCrw['crw_rdn']; ?>
                                }, {
                                    name: "Mitra Anugerah 32",
                                    value: <?= $dataSubCrw['crw_ma32']; ?>
                                }, {
                                    name: "Mitra Anugerah 35",
                                    value: <?= $dataSubCrw['crw_ma35']; ?>
                                }, {
                                    name: "Enc Kalijapat 2",
                                    value: <?= $dataSubCrw['crw_kj2']; ?>
                                }, {
                                    name: "Enc Kalijapat 3",
                                    value: <?= $dataSubCrw['crw_kj3']; ?>
                                }]
                            }, {
                                ...
                                "subData": [{
                                    name: "Report",
                                    value: <?= $dataSubGa['ga_report']; ?>
                                }, {
                                    name: "List Inventory",
                                    value: <?= $dataSubGa['ga_lstinv']; ?>
                                }, {
                                    name: "Letter Out",
                                    value: <?= $dataSubGa['ga_ltrout']; ?>
                                }, {
                                    name: "Letter In",
                                    value: <?= $dataSubGa['ga_ltrin']; ?>
                                }, {
                                    name: "Transmital Receipt",
                                    value: <?= $dataSubGa['ga_transrcpt']; ?>
                                }, {
                                    name: "Document Check List",
                                    value: <?= $dataSubGa['ga_docchklst']; ?>
                                }, {
                                    name: "Material Requistion Office",
                                    value: <?= $dataSubGa['ga_matreqoff']; ?>
                                }, {
                                    name: "Receptionist",
                                    value: <?= $dataSubGa['ga_rcptnst']; ?>
                                }, {
                                    name: "Minutes Of Meeting",
                                    value: <?= $dataSubGa['ga_mntofmeet']; ?>
                                }, {
                                    name: "Security",
                                    value: <?= $dataSubGa['ga_security']; ?>
                                }, {
                                    name: "Office Boy",
                                    value: <?= $dataSubGa['ga_officeboy']; ?>
                                }, {
                                    name: "Scaning Document",
                                    value: <?= $dataSubGa['ga_scandoc']; ?>
                                }]
                            }, {
                                "data": "HR Dept",
                                ...
                                "subData": [{
                                    ...
                                    value: <?= $dataSubHr['EMP_DB']; ?>
                                }, {
                                    name: "Payroll",
                                    value: <?= $dataSubHr['PAYROLL']; ?>
                                }, {
                                    name: "Permit Bussiness Trip",
                                    value: <?= $dataSubHr['PRMT_BNSTRIP']; ?>
                                }, {
                                    name: "Personal Report",
                                    value: <?= $dataSubHr['PRSNL_RPT']; ?>
                                }, {
                                    name: "Assesment",
                                    value: <?= $dataSubHr['ASSEST']; ?>
                                }, {
                                    name: "Insurance",
                                    value: <?= $dataSubHr['INSRNC']; ?>
                                }, {
                                    name: "TAX",
                                    value: <?= $dataSubHr['TAX']; ?>
                                }, {
                                    name: "Recruitment",
                                    value: <?= $dataSubHr['RCRTMN']; ?>
                                }, {
                                    name: "Employee Status",
                                    value: <?= $dataSubHr['EMP_STATUS']; ?>
                                }, {
                                    name: "Data Warning Employee",
                                    value: <?= $dataSubHr['DT_WRNGEMP']; ?>
                                }, {
                                    name: "Shore Employee Certificate (Hold)",
                                    value: <?= $dataSubHr['SHR_EMPCRT']; ?>
                                }, {
                                    name: "Update Regulation Kemenaker",
                                    value: <?= $dataSubHr['UPD_REGKMNKR']; ?>
                                }, {
                                    name: "Update Regulation Company",
                                    value: <?= $dataSubHr['UPD_REGCOMP']; ?>
                                }, {
                                    name: "Absence",
                                    value: <?= $dataSubHr['ABSENCE']; ?>
                                }, {
                                    name: "Over Time",
                                    value: <?= $dataSubHr['OVER_TIME']; ?>
                                }, {
                                    name: "Bonus",
                                    value: <?= $dataSubHr['BONUS']; ?>
                                }, {
                                    name: "THR",
                                    value: <?= $dataSubHr['THR']; ?>
                                }, {
                                    ...
                                    name: "Paklaring Employee",
                                    value: <?= $dataSubHr['PAKLR_EMP']; ?>
                                }, {
                                    name: "Legal",
                                    value: <?= $dataSubHr['LEGAL']; ?>
                                }, {
                                    name: "MCU Employee",
                                    value: <?= $dataSubHr['MCU_EMP']; ?>
                                }, {
                                    name: "Training Matrix Employee",
                                    value: <?= $dataSubHr['TRNG_MTRXEMP']; ?>
                                }, {
                                    name: "Status Keluarga Database Employee",
                                ...
                                "subData": [{
                                    name: "Finance",
                                    value: <?= $dataSubFin['FINANCE'] ?>
                                }, {
                                    name: "Accounting",
                                    value: <?= $dataSubFin['ACCNTNG'] ?>
                                }, {
                                    name: "Procurement",
                                    value: <?= $dataSubFin['PRCRMNT'] ?>
                                }]
                            }, {
                                "data": "Marketing Dept",
                                "value": <?= $dataQuery['mkt_dept']; ?>,
                                "subData": [{
                                    name: "Ship Particulars Owned By PEIP",
                                    value: <?= $dataSubMkt['SPOBP']; ?>
                                }, {
                                    name: "Q88 Owned By PEIP",
                                    value: <?= $dataSubMkt['Q88_OBP']; ?>
                                }, {
                                    name: "Ship Particulars & Q88 Own By Others",
                                    value: <?= $dataSubMkt['SPQ_88']; ?>
                                }, {
                                    name: "Tender Process",
                                    value: <?= $dataSubMkt['TNDR_PRCS']; ?>
                                }, {
                                    name: "Project Plan",
                                    value: <?= $dataSubMkt['PRJ_PLAN']; ?>
                                }, {
                                    name: "Project Awarded",
                                    value: <?= $dataSubMkt['PRJ_AWRD']; ?>
                                }, {
                                    name: "Update Civd",
                                    value: <?= $dataSubMkt['UPD_CIVD']; ?>
                                }, {
                                    name: "List Bid Bond And Performace Bond",
                                    value: <?= $dataSubMkt['LBBAPB']; ?>
                                }, {
                                    name: "List Project On Going",
                                    value: <?= $dataSubMkt['LST_PRJGNG']; ?>
                                }, {
                                    name: "Certificate ON/OFF Hire",
                                    value: <?= $dataSubMkt['CERT_HIRE']; ?>
                                }, {
                                    name: "Process Invoice",
                                    value: <?= $dataSubMkt['PRCS_INVC']; ?>
                                }]
                            }, {
                                "data": "QHSE Dept",
                                ...
                                "subData": [{
                                    name: "HSE Plan",
                                    value: <?= $dataSubHse['HSE_PLAN']; ?>
                                }, {
                                    name: "Policy",
                                    value: <?= $dataSubHse['POLICY']; ?>
                                }, {
                                    name: "SOP Company",
                                    value: <?= $dataSubHse['SOP_COMP']; ?>
                                }, {
                                    name: "Drill Schedule",
                                    value: <?= $dataSubHse['DRILL_SCHD']; ?>
                                }, {
                                    name: "Training",
                                    value: <?= $dataSubHse['TRNG']; ?>
                                }, {
                                    name: "I Care",
                                    value: <?= $dataSubHse['I_CARE']; ?>
                                }, {
                                    name: "Hospital Agreement",
                                    value: <?= $dataSubHse['HSPT_AGGRM']; ?>
                                }, {
                                    name: "List APD",
                                    value: <?= $dataSubHse['LIST_APD']; ?>
                                }, {
                                    name: "Certificate CSMS List",
                                    value: <?= $dataSubHse['CRT_CSMSLST']; ?>
                                }, {
                                    name: "KPI",
                                    value: <?= $dataSubHse['KPI']; ?>
                                }, {
                                    name: "DOC Preparation",
                                    value: <?= $dataSubHse['DOC_PRPTN']; ?>
                                }, {
                                    name: "SMC Preparation",
                                    value: <?= $dataSubHse['SMC_PRPTN']; ?>
                                }, {
                                    name: "ISO",
                                    value: <?= $dataSubHse['ISO']; ?>
                                }, {
                                    name: "Structural Organization Update",
                                    value: <?= $dataSubHse['STR_ORGUPD']; ?>
                                }, {
                                    name: "Scope Of Work Organization",
                                    value: <?= $dataSubHse['SCP_OWO']; ?>
                                }, {
                                    name: "Update Form Company",
                                    value: <?= $dataSubHse['UPD_FRMCOMP']; ?>
                                }, {
                                    name: "Management Of Change",
                                    value: <?= $dataSubHse['MGMT_CHNG']; ?>
                                }, {
                                    name: "Hand Over Report",
                                    value: <?= $dataSubHse['HND_OVRRPT']; ?>
                                }]
                            }, {
                                ...
                                "subData": [{
                                    name: "Gas Nuri Arizona",
                                    value: <?= $dataSubTech['GNA']; ?>
                                }, {
                                    name: "Enc Rhayden",
                                    value: <?= $dataSubTech['ENC_RDN']; ?>
                                }, {
                                    name: "Mitra Anugerah 32",
                                    value: <?= $dataSubTech['MA_32']; ?>
                                }, {
                                    name: "Mitra Anugerah 35",
                                    value: <?= $dataSubTech['MA_35']; ?>
                                }, {
                                    name: "Enc Kalijapat 2",
                                    value: <?= $dataSubTech['ENC_KJ2']; ?>
                                }, {
                                    name: "Enc Kalijapat 3",
                                    value: <?= $dataSubTech['ENC_KJ3']; ?>
                                }]
                            }];
                    ...
                    <!-- nampilin data yg Expired -->
                    <br><br>
                    <?php if ($totalExpired > 0) { ?>
                        <div align="right">
                            <div class="col-lg-5 col-xs-6">
                                <div class="list-group">
                                    <a href="#" class="list-group-item active" style="text-align: left">Dokumen Kadaluarsa</a>
                                    <?php while ($dataExpired = mysqli_fetch_assoc($queryExpired)) { ?>
                                        <a href="index.php?p=dokumen&folder=<?= base64_encode($dataExpired['kd_folder']); ?>" class="list-group-item" style="text-align: left" title="<?= $dataExpired['menu']; ?> | <?= $dataExpired['sub_folder'] ?>"><i class="<?= $dataExpired['logo']; ?>"></i>&nbsp;<?= $dataExpired['sub_menu']; ?><span class="badge badge-danger float-right"><?= $dataExpired['jml_dok']; ?></span></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
