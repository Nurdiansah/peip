<?php
    ...
    if(isset($_POST['edit_dokumen'])){
        ...
        if($cekDokumen > 0){
			...
			$rubahData = mysqli_query($conn,"UPDATE dokumen SET nm_dokumen='$nama_dokumen', thn_dokumen='$tahun_dokumen', dirubah_oleh='$user', waktu_dirubah=now(), expired='$expired_dokumen', file='$dokumen'
